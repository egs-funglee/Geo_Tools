Module Tab3_xyz_Module3

    Sub Invert_XYZ(input_listbox As System.Windows.Forms.ListBox)
        ...
        For k = 0 To input_listbox.Items.Count - 1
            ...
            If dot > 5 Then
                ...
                For Each line As String In System.IO.File.ReadLines(input_listbox.Items(k).ToString)
                    ...
                    End If
                Next
                outputfile = Strings.Left(input_listbox.Items(k).ToString, dot) + "_Invert." + Strings.Right(input_listbox.Items(k).ToString, 3)
                Try
